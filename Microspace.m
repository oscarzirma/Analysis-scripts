...
img(Info(1,2)*4+12,Info(1,1)*4+12)=0.5*max(max(img));
img(Info(2,2)*4+12,Info(2,1)*4+12)=0.4*max(max(img));
img(Info(3,2)*4+12,Info(3,1)*4+12)=0.4*max(max(img));
...
img(Info(1,2)*4+12,Info(1,1)*4+12)=.5*max(max(img));
img(Info(2,2)*4+12,Info(2,1)*4+12)=.4*max(max(img));
img(Info(3,2)*4+12,Info(3,1)*4+12)=.4*max(max(img));
