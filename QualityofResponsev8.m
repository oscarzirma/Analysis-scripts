function QualityofResponsev8(Ridges,Baselines)
...
if(~isempty(Ridges))%Pool the results from the rigde experiments and baseline experiments
    ...
    dlmwrite('RidgeAll.txt','Ridge - Angle - Distance','delimiter','')
    dlmwrite('RidgeAll.txt','Initial - Reaction - Estimate - Best','delimiter','','-append')
    dlmwrite('RidgeAll.txt',[RidgeAI RidgeAR RidgeAE RidgeAB RidgeDI RidgeDR RidgeDE RidgeDB],'delimiter','\t','-append')
    
    dlmwrite('BaselineAll.txt','Baseline - Angle - Distance','delimiter','')
    dlmwrite('BaselineAll.txt','Initial - Reaction - Estimate - Best','delimiter','','-append')
    dlmwrite('BaselineAll.txt',[BaselineAI BaselineAR BaselineAE BaselineAB BaselineDI BaselineDR BaselineDE BaselineDB],'delimiter','\t','-append')
