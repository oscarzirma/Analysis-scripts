 notes    = 'stage_3';%any relevant notes, e.g. stim parameters
...
gabor_frequency  = .5;%gabor frequency in cycles per degree
...
response_circle_radius = 8;%radius of circle displayed on screen (in pixels)
