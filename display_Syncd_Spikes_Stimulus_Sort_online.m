function [all_syncedEvents responseStrength]=display_Syncd_Spikes_Stimulus_Sort_online(syncEvent_Full,spikeEvent_Full,prePad,postPad,stimulus_sort,group_title)
