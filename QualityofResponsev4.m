...
dlmwrite('Times.txt',Times,'delimiter','\t')
dlmwrite('Times.txt','!','delimiter','\t','-append')
dlmwrite('Times.txt',sum(Times)./M,'delimiter','\t','-append')
