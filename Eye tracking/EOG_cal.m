function [eog_event_times,V_shift,eog_pix_shifts,eog_deg_shifts,eog_eye_size,conversion,scaled_trace]=EOG_cal(data,mov,Fs,eye_size,eye_rotation_depth,gain,trace_number)
