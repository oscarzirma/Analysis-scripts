function Eyetech_Mag_Correlation(eye,mdata,shift)
...
v_time = eye(1,:)./1000;%time for centroid/video trace. assume 30fps frame rate
centroid=eye(2:3,:)';
...
figure;
plot3(m1_vs_X(:,2),m1_vs_X(:,1),m1_vs_Y(:,1),'o');

figure
subplot(211)
plot(v_time(250:end),m2_vs_X(250:end,1));title('X');
subplot(212)
plot(v_time(250:end),m2_vs_X(250:end,2));title('Mb')
