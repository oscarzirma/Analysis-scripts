...
if(~isempty(RidgeDI))%Pool the results from the rigde experiments and baseline experiments
    ...
    dlmwrite('RidgeAllV10.txt','Initial - Reaction - Estimate - Best - Fish Angle Initial - Fish Angle Estimate - Fish Angle Final','delimiter','','-append')
    dlmwrite('RidgeAllV10.txt',[RidgeAI RidgeAR RidgeAE RidgeAB RidgeDI RidgeDR RidgeDE RidgeDB RidgeFAI RidgeFAE RidgeFAF],'delimiter','\t','-append')
    
    dlmwrite('BaselineAllV10.txt','Baseline - Angle - Distance','delimiter','')
    dlmwrite('BaselineAllV10.txt','Initial - Reaction - Estimate - Best - Fish Angle Initial - Fish Angle Estimate - Fish Angle Final','delimiter','','-append')
    dlmwrite('BaselineAllV10.txt',[BaselineAI BaselineAR BaselineAE BaselineAB BaselineDI BaselineDR BaselineDE BaselineDB BaselineFAI BaselineFAE BaselineFAF],'delimiter','\t','-append')
