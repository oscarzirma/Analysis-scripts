function [t E rF spike_rate]=display_spikes(Rdata,index,labels,PD,vdelay_duration)
...
for i=1:g
    ...
    delay=vdelay_duration(index==i);
    
    figure(rast)
    subplot(g,1,i)
    set(gca,'YTick',10)
    set(gca,'YTickLabel',num2str(-labels(i)))
    set(gca,'XTick',[])
    ...
    ax=axis;ax(1)=-.025;ax(2)=t(end)-.6;axis(ax);%fix raster axis
