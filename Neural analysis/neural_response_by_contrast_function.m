function neural_response_by_contrast_function(Neural,PD,stimuli_positions,posner_index,RF_pos,contrast_index,reaction_time,succFlag_index)
...
[iCon iInc] = get_congruent_indices(stimuli_positions,posner_index,RF_pos);
