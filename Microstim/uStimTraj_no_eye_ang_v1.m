function [uX uY uZ ms_amp] = uStimTraj_no_eye_ang(headPosition,microstim_index,STI,filename)
...
[t tmp1 tmp2 tmp3 Ydist Xdist Zdist] = getHeadPosfromCells_ang(headPosition,0,3,.008);
