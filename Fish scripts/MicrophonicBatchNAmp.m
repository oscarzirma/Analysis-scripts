...
function [Frequency,Amplitude]=MicrophonicBatchNAmp(Range,Interval,Freq,Srate,N,display)
...
%Takes in N amplitudes.

file=dir('Run **.txt');

Frequency=zeros(length(file),N*3);
Amplitude=zeros(length(file),N*3);
