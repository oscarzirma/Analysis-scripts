function [Frequency,Amplitude]=MicrophonicBatchI(Range,Interval,Freq,Srate,display)
...
%Amplitude is integrated over frequency +/- 1.
...
n=L/2;
ampspec=abs(z)/n;
a=ampspec(IFreqT)+ampspec(IFreqT-1)+ampspec(IFreqT+1);
return
